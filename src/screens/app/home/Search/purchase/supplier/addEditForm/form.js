                        ...
                        {(formikProps) => (
                            <View>
                                ...
                                <ICustomPicker
                                    ...
                                    formikProps={formikProps}
                                    onChange ={(item) => {
                                        getBranchDDl(item.bankId,setBanKBranchDDL)
                                        formikProps.setFieldValue("bankName",item)
